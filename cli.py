...
def delete_client(client_id):
    ...
    try:
        ...
        session.commit()
        console.print(
            f"[bold green]Client {client_id} deleted successfully![/bold green]"
        )
    except Exception as e:
...
@click.option(
    "--client_id", prompt="Client ID", help="The ID of the client for the contract."
)
@click.option(
    "--total_amount",
    prompt="Total Amount",
...
@click.option(
    ...
    help="The amount remaining on the contract.",
    type=float,
)
@click.option(
    "--signed",
    prompt="Signed (yes/no)",
    help="Whether the contract is signed.",
    type=bool,
)
def add_contract(client_id, total_amount, amount_remaining, signed):
    ...
    try:
        ...
        session.commit()
        console.print(
            f"[bold green]Contract for client {client_id} added successfully![/bold green]"
        )
    except Exception as e:
...
def delete_contract(contract_id):
    ...
    try:
        ...
        session.commit()
        console.print(
            f"[bold green]Contract {contract_id} deleted successfully![/bold green]"
        )
    except Exception as e:
...
@click.option(
    "--total_amount",
    prompt="Total Amount",
    help="The new total amount of the contract.",
    type=float,
)
@click.option(
    "--amount_remaining",
    prompt="Amount Remaining",
    help="The new amount remaining on the contract.",
    type=float,
)
@click.option(
    "--signed",
...
@event.command("add")
@click.option(
    "--contract_id", prompt="Contract ID", help="The ID of the contract for the event."
)
...
def add_event(contract_id, client_name, location, start_date, end_date):
    ...
    try:
        ...
        session.commit()
        console.print(
            f"[bold green]Event for contract {contract_id} added successfully![/bold green]"
        )
    except Exception as e:
...
@click.option(
    "--start_date", prompt="Start Date", help="The new start date of the event."
)
...
def update_event(event_id, location, start_date, end_date):
    ...
    try:
        ...
        if event:
            ...
            session.commit()
            console.print(
                f"[bold green]Event {event_id} updated successfully![/bold green]"
            )
        else:
